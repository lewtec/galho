...
**- Pattern:** Do not refactor core logic (like `moduleMatchesName`, `NewDatabaseModule`, or migration sorting) purely to simplify code that is already working (e.g., removing explicit parent directory checks).
